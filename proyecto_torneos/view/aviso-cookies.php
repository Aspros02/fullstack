...
<div class="container">
	...
	<div id="text">
		<h2 class="neonTitle">Avis<span id="offset">o de</span> cookies</h2>
	</div>
		...
		<li><b>Cookies técnicas:</b> Son aquellas que permiten al usuario la navegación a través del área restringida y la utilización de sus diferentes funciones, como por ejemplo, llevar a cambio el proceso de compra de un artículo.</li>
